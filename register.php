...
<body>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('images/img_back_3.png');">
        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form id="signup_form" onsubmit="return false" class="was-validated">
              ...
              <div class="form-group">
                <input type="email" name="email" class="form-control field-border" placeholder="Your Email(don't provide college mail)" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control field-border" name="mobile" placeholder="mobile no" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control field-border" name="college" placeholder="Enter your college" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control field-border" name="branch" placeholder="branch" required>
              </div>
              <!--div class="form-group">
                <input type="text" class="form-control field-border" name="Sem" placeholder="sem" required>
              </div-->
              
              <!--label for="sem">Semester:</label-->
               <!--input type="number" id="sem" name="sem" min="1" max="10" placeholder="Enter your semester" required>
               <input type="number" class="form-control field-border" name="sem" placeholder="Enter your semester" required-->
