      ...
      <div class="container">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> Innovate College of Engineering
                        Vamanjoor Cross, Vamanjoor,Mangalore
                        moodbidri road, Mangalore - 560 069,
                        Karnataka, India. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 9535688928</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">cse2k23@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://rrce.org" target="_blank">ICE CSE</a>
  </p>
          </div>
        </div>
      </div>
